	...
	render() {
		...
		return (
			<BrowserRouter>
				...
				<div class="footer">
      <h4>About Us</h4>
      <p>Our Company provides one of the best franchise restautrants in your city</p>
      <div class="icons">
      ...
      <p class="made">Made with <i class="fas fa-heart"></i> by Abhishek Goyal</p>
      <p><i class="fas fa-copyright"></i> 2021. All Rights Reserved</p>
